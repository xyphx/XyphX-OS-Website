...
export const Features = () => {
  return (
    <section className="py-24 px-6 bg-black/60 backdrop-blur-sm border-y border-purple-500/20">
      <div className="max-w-6xl mx-auto">
        <h2 className="text-4xl md:text-5xl font-bold text-center mb-16 bg-gradient-to-r from-purple-400 to-purple-600 bg-clip-text text-transparent hover:scale-105 transition-transform duration-300 cursor-default">
          Features
        </h2>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            <div
              key={index}
              className="group text-center p-8 rounded-xl bg-black/60 border-2 border-purple-500/30 hover:border-purple-400/60 transition-all duration-500 hover:scale-105 hover:shadow-[0_0_35px_rgba(168,85,247,0.4)] cursor-pointer"
              style={{ animationDelay: `${index * 150}ms` }}
            >
              <div className="mb-6 flex justify-center relative">
                <div className="p-4 rounded-full bg-purple-600/20 group-hover:bg-purple-500/40 transition-all duration-500 group-hover:scale-110">
                  <feature.icon className="w-8 h-8 text-purple-400 group-hover:text-purple-300 group-hover:scale-125 transition-all duration-500" />
                </div>
