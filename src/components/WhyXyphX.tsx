      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            <div
              key={index}
              className="group bg-black/40 backdrop-blur-md rounded-xl p-8 border-2 border-purple-500/30 hover:border-purple-400/60 transition-all duration-500 hover:shadow-[0_0_40px_rgba(168,85,247,0.3)] hover:scale-105 cursor-pointer"
              style={{ animationDelay: `${index * 100}ms` }}
            >
              <div className="mb-6 relative">
                <div className="p-3 rounded-full bg-purple-600/20 group-hover:bg-purple-500/30 transition-all duration-300 inline-block">
                  <feature.icon className="w-12 h-12 text-purple-400 group-hover:text-purple-300 transition-all duration-300 group-hover:scale-125 transform" />
                </div>
